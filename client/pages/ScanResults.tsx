            ...
            <div className="bg-layer-01 border border-ui-03 rounded p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="carbon-type-body-01 text-text-01 font-mono">
                    {scanInfo.scanId}
                  </p>
                </div>
                <div>
            ...
            <div className="bg-layer-01 border border-ui-03 rounded p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-support-01 rounded">
                  <span className="carbon-type-body-01 text-white">
                    Critical Issues
                  </span>
                  <span className="carbon-type-productive-heading-02 text-white">
                    3
                  </span>
                </div>
